...
list = [15, 17, 19, 21, 23, 25, 27, 29, 31, 35, 39, 41, 45, 49, 55, 179]
def main():
    for i in range(16):
        # if(i!=15):
        #     continue
        ...
        Latent.save(os.path.join(results_dir, f'{path[0:-4]}_{i+1}.png'))
        ...
        kernel.save(os.path.join(results_dir, f'{path[0:-4]}_{i+1}_kernel.png'))    
        # Lmx = Latent.max()
        # Lmn = Latent.min()
